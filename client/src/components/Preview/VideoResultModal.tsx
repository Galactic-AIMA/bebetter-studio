...
export default function VideoResultModal({ src, filename, onClose }: Props) {
  return (
    ...
    >
      <div className="relative bg-carbon-800 rounded-xl overflow-hidden shadow-2xl flex flex-col max-h-[92dvh]">
        <button
          onClick={onClose}
        ...
        <video src={src} controls autoPlay playsInline className="max-h-[86dvh] w-auto bg-black" />
        {filename && (
